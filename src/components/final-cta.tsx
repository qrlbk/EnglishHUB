...
export function FinalCta() {
  return (
    <section className="bg-gradient-to-r from-[#0a1628] to-[#1e3a5f] py-[clamp(2.2rem,5.2vw,3.5rem)]" aria-label="Итоговый призыв">
      <SectionReveal className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-5 px-[clamp(0.9rem,3.4vw,1.5rem)] md:flex-row md:items-center">
          ...
          <motion.a
            ...
            onClick={() =>
              trackEvent(
                ...
                { sourceHint: "final_cta" },
                { source: "final_cta", step: "decision", dedupeKey: "offer-accept:final-cta" },
              )
            }
